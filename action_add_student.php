  ...
  <?php
      if(isset($_POST['student_add'])){
          ...
          // $comment = $_POST['comment'];
               ...
               VALUES ('$student_sapid', '$s_f_name', '$s_l_name', '$email', '$mobile', '$emergency', '$emergency_contact', '$date', '$gender', '$address', '$city', '$pincode', '$state', '$country', '$bloodgroup', '$allergy', '$prescription',
